...
if samplerate == 32000000:
    timescale_unit = '31250000 fs'

if samplerate == 24000000:
    timescale_unit = '41666667 fs'

if samplerate == 12000000:
    timescale_unit = '83333333 fs'
